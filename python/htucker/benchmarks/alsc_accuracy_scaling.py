...
class ARGS_alsc_accuracy_scaling:
  verbose : int = 0
  Nx : int = 100
  Ny : int = 10
  Ny_decay : bool = True
...
def alsc_accuracy_scaling(args : ARGS_alsc_accuracy_scaling):
  print('Running accuracy scaling test...')
