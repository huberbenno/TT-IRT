...
class DimensionTree:
    ...
    def dfs_order(self, branch='l'):
        """
        Return DFS ordering of the notes.

        Parameters
        ----------
        branch : str, optional
            order in which to traverse subtrees. 'l' for left-to-right, 'r' for
            right-to-left, 'rand' for random order.

        Returns
        -------
        numpy.ndarray
            indices of nodes in DFS order.
        """
